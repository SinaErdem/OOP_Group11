...
"background-color: transparent;"));
        ...
        signinButton->setGeometry(QRect(40, 370, 341, 41));
...
"}"));
        LibMagaer_logo = new QLabel(centralwidget);
        LibMagaer_logo->setObjectName("LibMagaer_logo");
        LibMagaer_logo->setGeometry(QRect(460, 60, 349, 79));
        LibMagaer_logo->setStyleSheet(QString::fromUtf8("background-image: url(C:/LibManager/LibManager/LBResources/full_logo_LibManager_relieved.png);\n"
"background-color:transparent;"));
...
"background-color:transparent;"));
    ...
    void retranslateUi(QMainWindow *AuthScreen)
    {
        ...
        LibMagaer_logo->setText(QString());
